...
const createOurClassesTemplate = () => {
  ...
  return (
    `<section class="our-classes">
        <h2 class="our-classes__head">Наши классы</h2>
        <ul class="our-classes__list">
            <li class="our-classes__item">
                <h2 class="our-classes__title">Pilates START</h2>
                <p class="our-classes__text">Этот урок - знакомство с методом Пилатес, изучение базовых упражнений и основ техники выполнения.
            ...
            <li class="our-classes__item">
                <h2 class="our-classes__title">Pilates PROPS</h2>
                <p class="our-classes__text">На этом уроке к классическим упражнениям по методу Пилатес добавляется малое оборудование, такое как: пилатес-мяч (Soft Ball), пилатес-кольцо (Pilates Circle), пилатес-ролл (Foam Roller), ленточный амортизатор (Theraband).
            ...
            <li class="our-classes__item">
                <h2 class="our-classes__title">Stretching</h2>
                <p class="our-classes__text">Этот урок направлен на гармоничное развитие гибкости тела и улучшение мобильности суставов. 
            ...
            <li class="our-classes__item">
                <h2 class="our-classes__title">Spine Relax</h2>
                <p class="our-classes__text">Авторский урок от Дианы. Данный урок собрал в себя множество техник из направления Body&Mind.
                </p>
            </li>
            <li class="our-classes__item">
                <h2 class="our-classes__title">MOTOR</h2>
                <p class="our-classes__text">«MOre Than Roller» - это уникальный и инновационный тренажер, сочетающий в себе комфортный пилатес-ролл и амортизаторы с тремя уровнями сопротивления, который позволит Вам тренироваться в восьми различных положениях тела с быстрым переключением сопротивления. К тросам (амортизаторам) тренажера крепятся петли, что дает возможность полноценно проработать мышцы рук и ног, живота и спины с различной нагрузкой.
            ...
            <li class="our-classes__item">
                <h2 class="our-classes__title">ARC Pilates (или ARC&Stretch)</h2>
                <p class="our-classes__text">Класс с использованием легкого, изящного и очень функционального оборудования - Пилатес-Арки (Pilates Arc).
